...
def image_callback(msg, args):
    ...
    try:
        ...
        euler_angles[1] = euler_angles[1] - math.pi/2
        ...
        # t = getGeometryMsgTransform(parent, child, tran_pred, rot_pred, None)
...
def listener(model, node_name):
    ...
    debug = rospy.get_param("{}/debug".format(node_name))
    ...
    rospy.Subscriber(sub_topic, Image, image_callback, (child, parent, model, ps_prediction, debug), queue_size=1, buff_size=2**24)
